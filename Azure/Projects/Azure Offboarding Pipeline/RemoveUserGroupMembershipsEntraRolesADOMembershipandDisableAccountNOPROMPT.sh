...
#----------------------------------------
# Helper: Confirm action (auto-confirmed)
#----------------------------------------
confirm() {
...
process_user() {
  ...
  # 2. List group memberships and remove them
  echo ""
  ...
  # 3. List Azure RBAC Role Assignments and remove them
  echo ""
  ...
  # 4. List Directory (Entra) Roles and remove them
  echo ""
