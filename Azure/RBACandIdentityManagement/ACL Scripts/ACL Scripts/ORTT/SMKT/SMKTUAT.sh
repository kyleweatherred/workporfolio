...
subscription_id="a3173c88-868d-417b-b732-5b5178e2252a"
...
declare -A group_role_map=(
  ...
  ["ACL_SMKT_UAT_App_Configuration_Data_Owner"]="App Configuration Data Owner"
  ["ACL_SMKT_UAT_App_Configuration_Data_Reader"]="App Configuration Data Reader"
  ["ACL_SMKT_UAT_Automation_Contributor"]="Automation Contributor"
  ["ACL_SMKT_UAT_Automation_Job_Operator"]="Automation Job Operator"
  ["ACL_SMKT_UAT_Automation_Operator"]="Automation Operator"
  ["ACL_SMKT_UAT_Automation_Runbook_Operator"]="Automation Runbook Operator"
  ["ACL_SMKT_UAT_Azure_Container_Instances_Contributor_Role"]="Azure Container Instances Contributor Role"
  ["ACL_SMKT_UAT_Azure_Container_Storage_Contributor"]="Azure Container Storage Contributor"
  ["ACL_SMKT_UAT_Azure_Container_Storage_Operator"]="Azure Container Storage Operator"
  ["ACL_SMKT_UAT_Azure_Container_Storage_Owner"]="Azure Container Storage Owner"
  ["ACL_SMKT_UAT_Azure_Front_Door_Domain_Contributor"]="Azure Front Door Domain Contributor"
  ["ACL_SMKT_UAT_Azure_Front_Door_Domain_Reader"]="Azure Front Door Domain Reader"
  ["ACL_SMKT_UAT_Azure_Front_Door_Profile_Reader"]="Azure Front Door Profile Reader"
  ["ACL_SMKT_UAT_Azure_Front_Door_Secret_Contributor"]="Azure Front Door Secret Contributor"
  ["ACL_SMKT_UAT_Azure_Front_Door_Secret_Reader"]="Azure Front Door Secret Reader"
  ...
  ["ACL_SMKT_UAT_CDN_Endpoint_Contributor"]="CDN Endpoint Contributor"
  ["ACL_SMKT_UAT_CDN_Endpoint_Reader"]="CDN Endpoint Reader"
  ["ACL_SMKT_UAT_CDN_Profile_Contributor"]="CDN Profile Contributor"
  ["ACL_SMKT_UAT_CDN_Profile_Reader"]="CDN Profile Reader"
  ...
  ["ACL_SMKT_UAT_Logic_App_Contributor"]="Logic App Contributor"
  ["ACL_SMKT_UAT_Logic_App_Operator"]="Logic App Operator"
  ["ACL_SMKT_UAT_Managed_Application_Contributor_Role"]="Managed Application Contributor Role"
  ["ACL_SMKT_UAT_Managed_Application_Operator_Role"]="Managed Application Operator Role"
  ["ACL_SMKT_UAT_Managed_Applications_Reader"]="Managed Applications Reader"
  ["ACL_SMKT_UAT_Monitoring_Contributor"]="Monitoring Contributor"
  ["ACL_SMKT_UAT_Monitoring_Data_Reader"]="Monitoring Data Reader"
  ["ACL_SMKT_UAT_Monitoring_Metrics_Publisher"]="Monitoring Metrics Publisher"
  ["ACL_SMKT_UAT_Monitoring_Reader"]="Monitoring Reader"
  ...
  ["ACL_SMKT_UAT_Procurement_Contributor"]="Procurement Contributor"
  ["ACL_SMKT_UAT_Redis_Cache_Contributor"]="Redis Cache Contributor"
  ["ACL_SMKT_UAT_Security_Admin"]="Security Admin"
  ["ACL_SMKT_UAT_Security_Reader"]="Security Reader"
  ["ACL_SMKT_UAT_Services_Hub_Operator"]="Services Hub Operator"
  ["ACL_SMKT_UAT_SQL_DB_Contributor"]="SQL DB Contributor"
  ["ACL_SMKT_UAT_SQL_Managed_Instance_Contributor"]="SQL Managed Instance Contributor"
  ["ACL_SMKT_UAT_SQL_Security_Manager"]="SQL Security Manager"
  ["ACL_SMKT_UAT_SQL_Server_Contributor"]="SQL Server Contributor"
  ...
  ["ACL_SMKT_UAT_Storage_Account_Encryption_Scope_Contributor_Role"]="Storage Account Encryption Scope Contributor Role"
  ["ACL_SMKT_UAT_Storage_Account_Key_Operator_Service_Role"]="Storage Account Key Operator Service Role"
  ...
  ["ACL_SMKT_UAT_Storage_Blob_Delegator"]="Storage Blob Delegator"
  ...
  ["ACL_SMKT_UAT_Storage_Queue_Data_Contributor"]="Storage Queue Data Contributor"
  ["ACL_SMKT_UAT_Storage_Queue_Data_Message_Processor"]="Storage Queue Data Message Processor"
  ["ACL_SMKT_UAT_Storage_Queue_Data_Message_Sender"]="Storage Queue Data Message Sender"
  ["ACL_SMKT_UAT_Storage_Queue_Data_Reader"]="Storage Queue Data Reader"
  ["ACL_SMKT_UAT_Storage_Table_Data_Contributor"]="Storage Table Data Contributor"
  ["ACL_SMKT_UAT_Storage_Table_Data_Reader"]="Storage Table Data Reader"
  ["ACL_SMKT_UAT_Tag_Contributor"]="Tag Contributor"
  ["ACL_SMKT_UAT_Website_Contributor"]="Website Contributor"
)
